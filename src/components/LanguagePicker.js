            ...
            >
              {router.locales.filter((a) => a !== '_default').map((l) => (
                <option
                  ...
                  // update from nikhil: I believe this bug is fixed, even if it isn't, the line below breaks visibility on other browsers. 
                  // firefox is still usable without the line below.
